  ...
  return (
    <SafeAreaView edges={["top"]} style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <LinearGradient
        ...
        style={[styles.header, { borderBottomColor: colors.border, backgroundColor: colors.glass, paddingHorizontal: isNarrow ? 4 : 8 }]}
      >
        <TouchableOpacity testID="chat-back" onPress={() => router.back()} style={[styles.iconBtn, isNarrow && { width: 36, height: 36 }]}>
          <View style={[styles.headerIcon, { backgroundColor: colors.surfaceHigh, borderColor: colors.border }]}>
            <Feather name="chevron-left" size={isNarrow ? 24 : 26} color={colors.foreground} />
          </View>
        </TouchableOpacity>
        <TouchableOpacity style={{ flexDirection: "row", alignItems: "center", flex: 1, minWidth: 0 }} onPress={() => other && router.push(`/user/${other.username || other.user_id}`)}>
          <View style={[styles.avatarRing, { borderColor: otherTyping ? colors.primary : other?.online ? "#22C55E" : colors.border }]}>
            <Avatar
          ...
          <View style={{ marginLeft: 11, flex: 1, minWidth: 0 }}>
            <View style={{ flexDirection: "row", alignItems: "center" }}>
              <NxText variant="titleSm" numberOfLines={1} style={{ fontSize: isNarrow ? 16 : 17.5, fontFamily: fonts.bodySemi, flexShrink: 1 }}>{other?.display_name || "…"}</NxText>
              <VerifiedBadge
            ...
            <View style={{ flexDirection: "row", alignItems: "center", marginTop: 2 }}>
              <View style={[styles.presenceDot, { backgroundColor: otherTyping ? colors.primary : other?.online ? "#22C55E" : colors.mutedFg }]} />
              <NxText
                variant="caption"
                numberOfLines={1}
                style={{ color: otherTyping ? colors.primary : colors.mutedFg, fontSize: isNarrow ? 11 : 12, marginLeft: 5 }}
              >
        ...
        <View style={{ flexDirection: "row", alignItems: "center", gap: 4 }}>
          ...
          >
            <View style={[styles.headerIcon, { backgroundColor: colors.primary + "1F", borderColor: colors.primary + "40" }]}>
              <Feather name="phone" size={isNarrow ? 16 : 18} color={colors.primary} />
            </View>
          </TouchableOpacity>
          ...
          >
            <View style={[styles.headerIcon, { backgroundColor: colors.primary + "1F", borderColor: colors.primary + "40" }]}>
              <Feather name="video" size={isNarrow ? 16 : 18} color={colors.primary} />
            </View>
          </TouchableOpacity>
          ...
          <TouchableOpacity testID="chat-settings-toggle" onPress={() => setShowSettings(true)} style={[styles.iconBtn, isNarrow && { width: 32, height: 36 }]}>
            <View style={[styles.headerIcon, { backgroundColor: colors.surfaceHigh, borderColor: colors.border }]}>
              <Feather name="sliders" size={isNarrow ? 16 : 18} color={colors.foreground} />
            </View>
          </TouchableOpacity>
        </View>
      </LinearGradient>
            ...
            <View style={{ position: "relative" }}>
              {showAttachMenu ? (
                ...
                >
                  ...
                  >
                    <View style={[styles.attachIcon, { backgroundColor: "#8B5CF6" + "22" }]}>
                      <Feather name="image" size={18} color="#8B5CF6" />
                    </View>
                    <NxText style={{ marginLeft: 12, color: colors.foreground }}>
                      Photo
                    </NxText>
                  </TouchableOpacity>
                  ...
                  <TouchableOpacity
                    ...
                    style={styles.attachOption}
                  >
                    <View style={[styles.attachIcon, { backgroundColor: "#22C55E" + "22" }]}>
              ...
              <TouchableOpacity
                ...
                style={[
                  ...
                  isNarrow && styles.roundBtnSm,
                  {
                    ...
                    borderColor: showAttachMenu ? colors.primary : colors.border,
                  },
                ]}
              >
                <Feather
                  ...
                  size={isNarrow ? 20 : 22}
                  color={showAttachMenu ? colors.onPrimary : colors.primary}
                />
              </TouchableOpacity>
            </View>
          ) : null}
        ...
        >
          <View
            style={{
              ...
              borderRadius: 18,
              borderBottomRightRadius: row.side === "right" ? 6 : 18,
              borderBottomLeftRadius: row.side === "left" ? 6 : 18,
              backgroundColor:
                row.side === "right"
                  ? colors.primary + "30"
                  : colors.surface,
