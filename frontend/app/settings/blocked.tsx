        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View style={[styles.row, { backgroundColor: colors.surface, borderColor: colors.border }]}>
              <Avatar uri={item.profile_picture} name={item.display_name} size={40} frame={item.profile_frame} achievement={item.achievement_level} animation={item.profile_animation} animationSpeed={item.profile_animation_speed} animationIntensity={item.profile_animation_intensity} />
