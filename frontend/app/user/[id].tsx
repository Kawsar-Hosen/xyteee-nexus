    ...
    <SafeAreaView edges={["top"]} style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ paddingBottom: 40 }}>
        ...
        <View style={{ paddingHorizontal: spacing.lg }}>
          ...
          {/* Name + username + bio */}
          <Animated.View entering={FadeInDown.duration(400)} style={styles.identityBlock}>
            ...
            {!u.private_locked && u.bio ? (
              <NxText style={{ fontSize: 14, lineHeight: 21, textAlign: "center", color: colors.foreground, marginTop: 6, paddingHorizontal: 8 }}>
                {u.bio}
              </NxText>
            ) : null}
...
const styles = StyleSheet.create({
  ...
  identityBlock: { alignItems: "center", marginTop: 10, paddingHorizontal: 16 },
  notePill: {
    flexDirection: "row",
    alignItems: "center",
    alignSelf: "center",
